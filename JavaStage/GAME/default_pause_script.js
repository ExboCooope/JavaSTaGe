...
g_pause_menu.a1=new TextMenuItem("继续",1,1,{script:function(){   stgHideCanvas("pause");     _stgChangeGameState(stg_const.GAME_RUNNING);
    stgDeleteObject(default_pause_script);}},1);
g_pause_menu.a2=new TextMenuItem("结束游戏",1,1,{script:function(){stgHideCanvas("pause");stgCloseLevel();stgDeleteSelf();}},1);
